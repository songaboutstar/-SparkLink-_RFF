...
if __name__ == "__main__":
    ...
    data_of_data_label = torch.randn((10,1024))
    label_of_data_label = torch.ones((10))

    data_of_gdata_label = torch.randn((10,1024))
    label_of_gdata_label = torch.ones((10))

    data_of_data_clabel = torch.randn((10,1024))
    label_of_data_clabel = torch.ones((10))
